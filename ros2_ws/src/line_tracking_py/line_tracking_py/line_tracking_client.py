...
class LineTrackingActionClient(Node):

    def __init__(self):
        super().__init__('line_tracking_client')
        self._action_client = ActionClient(self, Order, 'line_tracking_order')
...
def main(args=None):
    ...
    action_client = LineTrackingActionClient()
